...
この問題に関する従来手法[1]は、文間の関係性を考慮しておらず、
...
文や文章の特徴量としては、パラグラフベクトル[2]が分類問題に対して
優れていることが示されている。
...
Nal Kalchbrenner et al.[3]やRie Johnson et al.[4]が
ニューラルネットワークを用いた評判分類を提案している。
これらの手法は従来のSVMやBag Of Words (BOW)、単語のn-gramを用いた手法を
超える精度を達成している。
-->
