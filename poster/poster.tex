...
\geometry{a4paper,portrait,left=2truemm,width=206truemm}
% "width" option of \geometry is ignored
% and \textwidth need to be set by \setlength somehow
\setlength{\textwidth}{206truemm} % HACK
